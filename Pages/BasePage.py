...
class BasePage:
    ...
    def click(self, locator):
        if str(locator).endswith("_Xpath"):
            ...
            self.driver.find_element(By.CSS_SELECTOR,
                                     ConfigReader.readconfig("locator", locator)).click()
    ...
    def enterValue(self, locator, value):
        if str(locator).endswith("_Xpath"):
            self.driver.find_element(By.XPATH,
                                     ConfigReader.readconfig("locator", locator)).send_keys(
                value)
        elif str(locator).endswith("_CSS"):
            self.driver.find_element(By.CSS_SELECTOR,
                                     ConfigReader.readconfig("locator", locator)).send_keys(
            ...
            self.driver.find_element(By.ID, ConfigReader.readconfig("locator", locator)).send_keys(
                value)
    ...
    def select(self, locator, value):
        ...
        if str(locator).endswith("_Xpath"):
            dropdown = self.driver.find_element(By.XPATH, ConfigReader.readconfig("locator", locator))
        elif str(locator).endswith("_CSS"):
            dropdown = self.driver.find_element(By.CSS_SELECTOR,
                                                ConfigReader.readconfig("locator", locator))
        elif str(locator).endswith("_ID"):
            dropdown = self.driver.find_element(By.ID, ConfigReader.readconfig("locator", locator))
    ...
    def mouseHover(self, locator):
        ...
        if str(locator).endswith("_Xpath"):
            ...
            ele = self.driver.find_element(By.ID, ConfigReader.readconfig("locator", locator))
